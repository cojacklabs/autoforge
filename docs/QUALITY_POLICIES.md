...
Targeted tests
- Coordinator attempts to detect Jest or Vitest and run tests for impacted files (findRelatedTests for Jest; direct paths for Vitest). If no runner is detected, it falls back to the configured `qualityPolicies.tests.cmd`.
