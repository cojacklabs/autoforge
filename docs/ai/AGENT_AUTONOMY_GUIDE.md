...
- Run `npm run update` periodically to pull upstream framework changes, reinstall dependencies, and rerun guardrails (local AutoForge edits are auto-stashed and restored).
