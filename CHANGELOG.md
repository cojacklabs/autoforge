...
- The AutoForge SDK is stabilized as a public protocol-versioned injected-operation facade. Its corrected first supported registry version is 0.1.1. (decision.the-autoforge-sdk-is-stabilized-as-a-public-0-1-0-protocol-versioned-injected-op)
...
- AutoForge 0.25.2 is the approved first supported v0.25 registry release, with compatibility migration guidance, independently versioned Protocol/Core/SDK packages, corrected publishable dependency ranges, and complete local and remote validation evidence. (decision.autoforge-0-25-0-is-prepared-as-an-audited-release-candidate-with-compatibility)
