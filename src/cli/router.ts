...
export async function runCli(
  ...
  switch (command) {
    ...
    case "domain":
      return dependencies.commands.domain
        ? dependencies.commands.domain(commandArgs)
        : EXIT_CODE.usage;
    ...
    case "update":
      return dependencies.commands.update
        ? dependencies.commands.update(commandArgs)
        : EXIT_CODE.usage;
    ...
    case "twin":
      return dependencies.commands.twin
        ? dependencies.commands.twin(commandArgs)
        : EXIT_CODE.usage;
